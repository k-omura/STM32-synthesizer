...
- General-MIDI data format.
- 16ch (G-MIDI 128 Instruments, 47 Drum Sounds(10ch)).
...
## Hot to use
### with USB-MIDI
1. Write the binary and connect your controller.
2. Connect PC and STM32 via USB and send MIDI data using MIDI software on PC.
### with MIDI over SPI
underconstration
